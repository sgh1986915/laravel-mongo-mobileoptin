...
(function ($) {
    ...
    //CSS for ddSlick
        ddslickCSS = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-optgroup{ padding:5px; display:block; border-bottom:solid 1px #ddd; overflow:hidden; color:#333; font-weight:bold!important;}' +
            ...
            if (!data) {
                ...
                obj.find('option,optgroup').each(function () {
                    ...
                    ddSelect.push({
                        ...
                        enambed_item: $this.data('enabled_field'),
