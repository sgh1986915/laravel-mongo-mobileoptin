...
<div class="row">
    <div class="col-md-8 ">
        <h1 class="category_header"><b>{{ $faq_category_name }}</b> / TEA Management</h1>
    </div>
    <div class="col-md-2 text-right pt-3"></div>
    <div class="col-md-2 text-right pt-26">
    	@if(Auth::user()->can('manage_index_user_content'))
        	<a href="{{ route('admin.expert_traffic.add', ['id'=> $faq_category_id])  }}" class="btn btn-green"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add a Question </a>
        @endif
    </div>
</div>
<div class="row">
                        	...
                        	<div class="dropdown">
	                        	<ul class="nav nav-pills">
	                                   ...
	                                   <ul class="dropdown-menu">	
	                                   		<li>
	                                        	<a href="{{ route('admin.expert_traffic.edit', ['category_id' => $faq_answer->faq_category_id, 'id'=> $faq_answer->id])  }}">Edit</a>
	                                       	</li>
	                                       	@if(!empty($pdf_link))
	                                        <li>    
	                                        	<a onclick="return confirm(' you want to delete the pdf?');" href="{{ route('admin.expert_traffic.delete.pdf', ['id'=> $faq_answer->id])  }}">Delete PDF</a>
	                                        </li>
	                                        @endif
	                                        <li>    
	                                        	<a onclick="return confirm(' you want to delete?');" href="{{ route('admin.expert_traffic.delete', ['id'=> $faq_answer->id])  }}">Delete</a>
	                                        </li>
	                                   </ul>
	                                </li>
	                             </ul>
