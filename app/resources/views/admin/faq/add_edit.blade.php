...
@section('content')
    <div class="row">
        <div class="col-md-6 ">
            <h1 class="category_header"><b>{{ $faq_category_name }}</b> / Add FAQ's Answer</h1>
        </div>
    ...
    <div id="creator_container">
        <div class="row">
            ...
            {!! Form::model($faq_answer, ['route' => ['admin.faq.add_edit', $faq_answer->id], 'class' => 'form-horizontal', 'files' => true]) !!}
             @else
            {!! Form::open(array('route'=>'admin.faq.add_edit', 'class' => 'form-horizontal', 'files' => true)) !!}
            @endif
