...
@section('content')
    <div class="row">
        <div class="col-md-6 ">
            <h1 class="category_header">Add FAQ's Category</h1>
        </div>
    ...
    <div id="creator_container">
        <div class="row">
            ...
            {!! Form::model($faq, ['route' => ['admin.faq.upsert_category', $faq->id], 'class' => 'form-horizontal']) !!}
             @else
            {!! Form::open(array('route'=>'admin.faq.upsert_category', 'class' => 'form-horizontal')) !!}
            @endif
