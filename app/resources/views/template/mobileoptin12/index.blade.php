...
@section('content')
  ...
  <section class="full-container" id="theme-12">
  <section class="container">
    <article class="content-box orange-dark-border">
    ...
    <!--content box-->
    <article class="content-box send-email orange-dark-border">
    ...
    <!--content box-->
    <article class="content-box orange-dark-border box-instant">
