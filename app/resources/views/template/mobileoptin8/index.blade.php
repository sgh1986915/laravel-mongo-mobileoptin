...
@section('content')
    ...
    <section class="full-container" id="theme-8">
  <section class="container">
    <article class="content-box gray-border">
    ...
    <!--content box-->
    <article class="content-box send-email gray-border">
    ...
    <!--content box-->
    <article class="content-box gray-border box-instant">
