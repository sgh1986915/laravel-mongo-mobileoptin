...
<section class="full-container" id="theme-15">
  <section class="container">
    <article class="content-box blue-dark-border">
    ...
    <!--content box-->
    <article class="content-box send-email blue-dark-border">
    ...
    <!--content box-->
    <article class="content-box blue-dark-border box-instant">
