...
<section class="full-container" id="theme-10">
  <section class="container">
    ...
    <!--content box-->
    <article class="content-box send-email blue-border">
    ...
    <!--content box-->
    <article class="content-box blue-border box-instant">
      ...
      <span class="button-instant link"><span class="link">Or Click Here to  SEND us an Email for Instant Access</a></span></span> </article>
    <!--content box--> 
  </section>
