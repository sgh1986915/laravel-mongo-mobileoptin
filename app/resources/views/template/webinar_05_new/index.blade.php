...
<header class="full gray-bg">
  <div class="middle_section">
    ...
    <p><strong>Lorem ipsum dolor sit amet,  adipiscing elit. Suspendisse sit amet lobortis justo, in mattis augue.</strong></p>
    <div class="registerbutton"><span class="link">Reserve My Spot Now!</span>
...
<section class="full colandar-section">
  <div class="middle_section">
  <div class="calender"><img src="/templates/webinar_05_new/images/calender_icon.png" width="82" height="82" alt=""></div>
...
<section class="full blue-box">
  <div class="middle_section">
    <div class="name_group">
      <div class="picture_1"><img src="/templates/webinar_05_new/images/man_pic.png" width="136" height="126" alt=""></div>
      <h2>Host Name</h2>
    ...
    <div class="name_group">
      <div class="picture_1"><img src="/templates/webinar_05_new/images/man_pic01.png" width="136" height="126" alt=""></div>
      <h2>Co-Host Name</h2>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy 
        text ever since when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
    </div>
...
<div class="full footer-gray">
  <div class="warning-img"><img src="/templates/webinar_05_new/images/warning_img.png" alt="">
