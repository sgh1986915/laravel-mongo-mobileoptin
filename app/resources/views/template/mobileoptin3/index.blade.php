...
@section('content')
  ...
  <section class="full-container" id="theme-3">
  <section class="container">
    <article class="content-box black-border">
    ...
    <!-- content box -->
    <article class="content-box send-email black-border">
    ...
    <!-- content box -->
    <article class="content-box black-border box-instant">
