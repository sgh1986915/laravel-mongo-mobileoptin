...
@section('content')
    ...
    <section class="full-container" id="theme-7">
  <section class="container">
    <article class="content-box red-border-light">
    ...
    <!--content box-->
    <article class="content-box send-email red-border-light">
    ...
    <!--content box-->
    <article class="content-box red-border-light box-instant">
