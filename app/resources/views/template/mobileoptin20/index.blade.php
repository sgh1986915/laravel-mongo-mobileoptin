...
<section class="full-container" id="theme-20">
  <section class="container">
    <article class="content-box red-border">
    ...
    <!--content box-->
    <article class="content-box send-email red-border">
    ...
    <!--content box-->
    <article class="content-box red-border box-instant">
