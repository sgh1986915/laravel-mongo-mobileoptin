...
<link href='http://fonts.googleapis.com/css?family=Lato:400,300,300italic,700,400italic' rel='stylesheet' type='text/css'><link href='http://fonts.googleapis.com/css?family=Oswald:400,300,700' rel='stylesheet' type='text/css'> <link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/templates/{{$template_path}}/css/style.css">
...
@section('content')
 ...
 <section class="full-container" id="theme-45">
  <section class="container">
    ...
    <!--content box-->
    <article class="content-box send-email border">
    ...
    <!--content box-->
    <article class="content-box border box-instant">
