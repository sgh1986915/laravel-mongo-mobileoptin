...
@section('content')
    ...
    <section class="full-container" id="theme-5">
  <section class="container">
    <article class="content-box green-border">
    ...
    <!--content box-->
    <article class="content-box send-email green-border">
    ...
    <!--content box-->
    <article class="content-box green-border box-instant">
