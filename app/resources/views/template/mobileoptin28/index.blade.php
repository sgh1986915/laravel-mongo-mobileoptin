...
<section class="full-container" id="theme-28">
  <section class="container">
    <article class="content-box orange-border">
    ...
    <!--content box-->
    <article class="content-box send-email orange-border">
  ...
  <footer id="footer">
    <nav>
      <ul>
        ...
        <li><a href="{{$therms_of_link}}" class="therms_of_s" target="_blank"> privacy Policy</a> </li>
        <li><a href="{{$therms_of_link}}" class="therms_of_s" target="_blank"> Contact us</a></li>
      </ul>
    </nav>
  </footer>
  <!-- footer ends--> 
