...
<section class="full-container" id="theme-16">
  <section class="container">
    <article class="content-box dark-dark-border">
    ...
    <!--content box-->
    <article class="content-box send-email dark-dark-border">
    ...
    <!--content box-->
    <article class="content-box dark-dark-border box-instant">
