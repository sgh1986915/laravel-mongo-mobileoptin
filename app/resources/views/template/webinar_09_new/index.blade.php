...
<header class="full gray-bg">
  ...
  <div class="middle_section">
    <div class="top-img"><img src="/templates/webinar_09_new/images/top-img.png" alt="" title="" height="294" width="475"></div>
    <p><span>Lorem ipsum dolor sit amet,  adipiscing elit. Suspendisse justo, in mattis augue.</span></p>
    <div class="registerbutton"><span class="link">Click Here To Save<br>
      Your Spot</span> <span class="arrow-left"></span> <span class="arrow-right"></span> </div>
  </div>
</header>
<section class="full colandar-section">
  <div class="middle_section">
    <div class="calender"><img src="/templates/webinar_09_new/images/calender_icon.png" width="82" height="82" alt=""></div>
...
<section class="full gray-box">
  <div class="middle_section">
    <div class="name_group">
      ...
      <div class="picture_1"><img src="/templates/webinar_09_new/images/man_pic.png" width="168" height="116" alt=""></div>
...
<div class="full footer-gray">
  <div class="registerbutton registerbutton2"><span class="link">Click Here To Save<br>
    Your Spot</span></div>
  <div class="warning-img"><img src="/templates/webinar_09_new/images/warning_img.png" alt=""> <span><strong>Warning:</strong><br>
