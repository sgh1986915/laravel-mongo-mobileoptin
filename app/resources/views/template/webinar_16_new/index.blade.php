...
<section class="full colandar-section">
  <div class="middle_section">
    <div class="calender"><img src="/templates/webinar_16_new/images/calender_icon.png" width="82" height="82" alt=""></div>
...
<section class="full gray-box">
  <div class="middle_section">
    <div class="name_group">
      ...
      <div class="picture_1"><img src="/templates/webinar_16_new/images/man_pic.png" width="165" height="135" alt=""></div>
    ...
    <div class="name_group">
      ...
      <div class="picture_1"><img src="/templates/webinar_16_new/images/man_pic_01.png" width="165" height="135" alt=""></div>
      <h4>Name of the Author</h4>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since when an unknown printer took a galley Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
    </div>
  </div>
...
<div class="full footer-gray">
  <div class="warning-img"><img src="/templates/webinar_16_new/images/warning_img.png" alt=""> <span><strong>Warning:</strong> Limited Space Available</span> </div>
  <div class="middle_section">
